...
public class AlarmService extends Service {
     ...
     * ALARM_DONE_ACTION).
     */
    public static final String ALARM_SNOOZE_ACTION = "de.danoeh.antennapod.core.alarm.deskclock.ALARM_SNOOZE";
     ...
     */
    public static final String ALARM_DISMISS_ACTION = "de.danoeh.antennapod.core.alarm.deskclock.ALARM_DISMISS";

    /** A public action sent by AlarmService when the alarm has started. */
    public static final String ALARM_ALERT_ACTION = "de.danoeh.antennapod.core.alarm.deskclock.ALARM_ALERT";

    /** A public action sent by AlarmService when the alarm has stopped for any reason. */
    public static final String ALARM_DONE_ACTION = "de.danoeh.antennapod.core.alarm.deskclock.ALARM_DONE";
