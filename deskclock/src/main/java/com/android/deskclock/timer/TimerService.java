...
public final class TimerService extends Service {
    ...
    private static final String ACTION_PREFIX = "de.danoeh.antennapod.core.alarm.deskclock.action.";
    ...
    public static final String EXTRA_TIMER_ID = "de.danoeh.antennapod.core.alarm.deskclock.extra.TIMER_ID";
