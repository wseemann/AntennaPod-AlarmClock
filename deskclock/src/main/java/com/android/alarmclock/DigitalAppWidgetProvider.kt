 ...
 * the License.
 */
package de.danoeh.antennapod.core.alarm.alarmclock
...
import de.danoeh.antennapod.core.alarm.deskclock.worldclock.CitySelectionActivity
...
class DigitalAppWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
         ...
         */
        private const val ACTION_ON_DAY_CHANGE = "de.danoeh.antennapod.core.alarm.deskclock.ON_DAY_CHANGE"
