 ...
 */
package de.danoeh.antennapod.core.alarm.deskclock.alarms;
...
import de.danoeh.antennapod.core.alarm.deskclock.AlarmAlertWakeLock;
import de.danoeh.antennapod.core.alarm.deskclock.AlarmClockFragment;
import de.danoeh.antennapod.core.alarm.deskclock.AlarmUtils;
import de.danoeh.antennapod.core.alarm.deskclock.AsyncHandler;
...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    public static final String ACTION_ALARM_CHANGED = "de.danoeh.antennapod.core.alarm.deskclock.ALARM_CHANGED";
    ...
    private static class AlarmManagerStateChangeScheduler implements StateChangeScheduler {
        ...
        public void scheduleInstanceStateChange(Context context, Calendar time,
            ...
            if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                pendingIntent = PendingIntent.getForegroundService(context, instance.hashCode(),
                        stateChangeIntent, PendingIntent.FLAG_UPDATE_CURRENT);
            } else {
                pendingIntent = PendingIntent.getService(context, instance.hashCode(),
                        stateChangeIntent, PendingIntent.FLAG_UPDATE_CURRENT);
            }
