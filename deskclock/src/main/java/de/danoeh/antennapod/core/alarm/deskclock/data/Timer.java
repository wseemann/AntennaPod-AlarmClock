...
import static de.danoeh.antennapod.core.alarm.deskclock.Utils.now;
import static de.danoeh.antennapod.core.alarm.deskclock.Utils.wallClock;
import static de.danoeh.antennapod.core.alarm.deskclock.data.Timer.State.EXPIRED;
import static de.danoeh.antennapod.core.alarm.deskclock.data.Timer.State.MISSED;
import static de.danoeh.antennapod.core.alarm.deskclock.data.Timer.State.PAUSED;
import static de.danoeh.antennapod.core.alarm.deskclock.data.Timer.State.RESET;
import static de.danoeh.antennapod.core.alarm.deskclock.data.Timer.State.RUNNING;
