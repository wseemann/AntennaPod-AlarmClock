...
package de.danoeh.antennapod.core.alarm.deskclock.timer;
...
import de.danoeh.antennapod.core.alarm.deskclock.data.TimerListener;
import de.danoeh.antennapod.core.alarm.deskclock.data.TimerStringFormatter;
...
public final class TimerFragment extends DeskClockFragment {
    ...
    private static final String EXTRA_TIMER_SETUP = "de.danoeh.antennapod.core.alarm.deskclock.action.TIMER_SETUP";
