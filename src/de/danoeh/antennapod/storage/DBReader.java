...
public final class DBReader {
    ...
    private static FeedMedia extractFeedMediaFromCursorRow(final Cursor cursor) {
        ...
        final String mimeType = cursor.getString(PodDBAdapter.KEY_MIME_TYPE_INDEX);
        if (StringUtils.equals(mimeType, BitTorrentFeedMedia.MIME_TYPE_BITTORRENT)) {
            return new BitTorrentFeedMedia(
                    mediaId,
                    null,
